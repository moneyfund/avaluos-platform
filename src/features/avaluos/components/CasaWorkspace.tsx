...
export default function CasaWorkspace() {
  ...
  return <main className='terrain-page'>
    <header className='terrain-hero'>
      <div><p className='terrain-kicker'>Avalúos Platform · núcleo independiente</p><h1>Avalúo técnico de casa</h1><p>Formulario profesional conectado al motor vigente de casas. En esta fase el cálculo funciona sin guardar datos en Firebase.</p></div>
